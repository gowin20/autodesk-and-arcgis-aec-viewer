...
export const CONTEXTUAL_LAYER_OPTIONS = [
	...
	},
	{
		...
		label: 'Internet broadband speed (Ookla)',
		...
		style: {
			...
			paint: {
				'fill-color': [
					'case',
					['>', ['to-number', ['get', 'AvgDown']], 400],
					'#166534',
					['>', ['to-number', ['get', 'AvgDown']], 150],
					'#86efac',
					['>', ['to-number', ['get', 'AvgDown']], 75],
					'#d2b48c',
					['>', ['to-number', ['get', 'AvgDown']], 25],
					'#c4b5fd',
					'#6b21a8'
				],
				'fill-opacity': 0.65
